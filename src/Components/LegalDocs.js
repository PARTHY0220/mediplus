  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Medi <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Medi Plus, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          Medi Plus is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2013-2023 MediPlus+. All rights reserved.</p>
      </div>
    </div>
  );
}
